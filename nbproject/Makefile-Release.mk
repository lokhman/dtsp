...
${OBJECTDIR}/src/dtsp.o: src/dtsp.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dtsp.o src/dtsp.c

${OBJECTDIR}/src/dtsp/aes.o: src/dtsp/aes.c 
	${MKDIR} -p ${OBJECTDIR}/src/dtsp
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dtsp/aes.o src/dtsp/aes.c

${OBJECTDIR}/src/dtsp/crc32.o: src/dtsp/crc32.c 
	${MKDIR} -p ${OBJECTDIR}/src/dtsp
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dtsp/crc32.o src/dtsp/crc32.c

${OBJECTDIR}/src/dtsp/isaac.o: src/dtsp/isaac.c 
	${MKDIR} -p ${OBJECTDIR}/src/dtsp
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dtsp/isaac.o src/dtsp/isaac.c

${OBJECTDIR}/src/dtsp/md5.o: src/dtsp/md5.c 
	${MKDIR} -p ${OBJECTDIR}/src/dtsp
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dtsp/md5.o src/dtsp/md5.c

${OBJECTDIR}/src/dtsp/tsearch.o: src/dtsp/tsearch.c 
	${MKDIR} -p ${OBJECTDIR}/src/dtsp
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/dtsp/tsearch.o src/dtsp/tsearch.c
